...
var render = function () {
  ...
  for (var i = 0; i < num_logo_arcs; i++) {
    ...
    for ( var a = 0; a < num_particles_per_arc; a++ ) {
      ...
      particle.position.x = logo_center.x + Math.cos(inc * a) * arc_radius * 0.55;
      particle.position.y = logo_center.y + Math.sin(inc * a) * arc_radius * (mouseX / 100.0);
      ...
      particle.position = rotateZ(particle.position, 445 / 100.0); // get this rotation correct
